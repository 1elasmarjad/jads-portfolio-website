...
export default function HomePage() {
  return (
    <main className="flex w-full flex-col items-center">
      <section className="flex w-full justify-between gap-24 px-12 lg:max-w-6xl">
        <header className="flex flex-col py-20 lg:sticky lg:h-screen lg:w-1/2 lg:justify-between">
          <div className="flex flex-col">
            ...
            <div className="mt-20 flex flex-col gap-5">
              ...
              <NavItem activated={false} text={"contact"}/>
            </div>
          </div>
          ...
          <ul className="flex gap-6">
            ...
            <li>
              <a href="https://www.linkedin.com/in/jadelasmar/">
                <Linkedin className="bg- stroke-foreground/70 transition-all hover:stroke-foreground" />
              </a>
            </li>
          </ul>
        </header>

        <div className="py-20 lg:w-1/2">test</div>
      </section>
    </main>
  );
}
